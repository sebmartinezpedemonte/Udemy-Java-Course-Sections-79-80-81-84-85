...
public class AppConfig {
	//Otra forma de inyectar sin usar @Component en las clases concretas servicios
	
	//Si trabajamos con clases externas de terceros u otros frameworks API,
	//por ejemplo del framework de Spring y la queremos ocupar/utilizar, la tenemos que
	//registrar de esta forma, usando @Configuration y @Bean
	...
	public List<ItemFactura> registrarItems(){
		...
		Producto producto2 = new Producto("Bicicleta Bianchi aron 26", 200);
